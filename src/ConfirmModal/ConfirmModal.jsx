    ...
    >
      <div className="modal-content p-5">
        ...
        <div className="mt-5 d-flex justify-content-end">
          <Button
            className="ac-modal--confirm__btn-dismiss btn btn-outline-dark m-3"
            style={{ border: 'transparent' }}
            onClick={onClose}
          >
            {dismissButtonLabel}
          </Button>
          <Button className={`ac-modal--confirm__btn-confirm btn btn-${dialogType} m-3`} onClick={onConfirm}>{confirmButtonLabel}</Button>
        </div>
      </div>
    </Modal>
  );
